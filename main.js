...
let quizArray = document.querySelector(".quiz-area");
let answerArray = document.querySelector(".answers-area");
...
function addQuestionData(obj,count) {
    ...
    quizArray.appendChild(questionTitle);
    ...
    for (let i = 1; i <= 4; i++) { 
        ...
        answerArray.appendChild(mainDiv);
    }
    }
}
